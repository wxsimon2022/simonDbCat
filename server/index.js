...
const connStore = require('./connections');
...
// --- Database Operations ---
async function getClient(connId) {
  ...
  return mysql.createConnection({
    ...
    database: conf.database || undefined,
...
app.listen(PORT, () => {
  console.log(`✅ MyDB server running at http://localhost:${PORT}`);
});
